...
(
    ...
    applicantlandphone_no character varying(13) COLLATE pg_catalog."default",
    applicantmobile_no character varying(14) COLLATE pg_catalog."default",
    ...
    applicant_aadharno character varying(12) COLLATE pg_catalog."default",
